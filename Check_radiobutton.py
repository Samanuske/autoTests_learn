...
#ищем радиобуттон и проверяем значение по умолчаю
#Способ 1
print("Проверяем значение по умолчанию для Rabiobutton = Люди рулят!. Способ 1...")
people_radio = driver.find_element_by_id("peopleRule")
people_checked = people_radio.get_attribute("checked")
print("value of people radio: ", people_checked)
assert people_checked is not None, "People radio is not selected by default"
#Способ 2
print("Проверяем значение по умолчанию для Rabiobutton = Люди рулят!. Способ 2...")
assert people_checked == "true", "People radio is not selected by default"
robots_radio = driver.find_element_by_id("robotsRule")
robots_checked = robots_radio.get_attribute("checked")
#assert robots_checked is None, "People radio is not selected by default"
if robots_checked is True:
  print ("выбран Robots Rule! - по умолчаню")
else: print ("выбран Люди рулят! - по умолчанию")


#ищем значение Х и считаем его по фомуле вызывая метод calc
